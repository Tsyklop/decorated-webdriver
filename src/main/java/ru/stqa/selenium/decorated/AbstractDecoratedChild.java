...
public abstract class AbstractDecoratedChild<T, DT extends DecoratedTopmost> extends AbstractDecorated<T> implements DecoratedChild<DT> {

  private DT topmost;

  public AbstractDecoratedChild(T original, DT topmost) {
    super(original);
