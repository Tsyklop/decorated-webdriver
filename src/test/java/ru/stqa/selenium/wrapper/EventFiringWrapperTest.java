...
public class EventFiringWrapperTest {
  ...
  public void canFireEventForGet() {
    ...
    EventFiringWrapper decorated = new EventFiringWrapper(mockedDriver);
    decorated.addListener(mockedListener);
    final WebDriver driver = new Decorator<WebDriver>().activate(decorated);
