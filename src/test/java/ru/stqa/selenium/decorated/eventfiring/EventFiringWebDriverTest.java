...
import ru.stqa.selenium.decorated.Activator;
import ru.stqa.selenium.decorated.DecoratedAlert;
...
public class EventFiringWebDriverTest {
  ...
  public void canFireEventForGet() {
    ...
    verify(fixture.mockedListener, times(1)).beforeGet(fixture.mockedDriver, "http://localhost/");
